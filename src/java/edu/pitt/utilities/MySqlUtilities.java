...
public class MySqlUtilities implements DbUtilities{
    ...
    //These parameters must be set to your database parameters.
    private String hostName = DbConfig.DB_HOST_NAME; // server address + port number
    private String dbName = DbConfig.DB_NAME; // default database name
    private String dbUserName = DbConfig.DB_USER_NAME; // login name for the database server
    private String dbPassword = DbConfig.DB_PASSWORD; // password for the database server
    ...
    /**
     * Silently closes a Database Connection while checking for null
     * @author Bill Conner
     */
    public void silentClose(){
        ...
        {
    		ErrorLogger.log("Unable to close Connection.");
			ErrorLogger.log(e.getMessage());
        }
    }
    
    /**
     * Silently closes a ResultSet while checking for null
     * @param rs - a record set
     * @author Bill Conner
     */
    public  void silentClose(ResultSet rs){
        ...
        {
    		ErrorLogger.log("Unable to close RecordSet.");
			ErrorLogger.log(e.getMessage());
        }
    }
